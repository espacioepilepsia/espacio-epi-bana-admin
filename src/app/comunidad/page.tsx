    ...
    <main>
      ...
      <section className="py-12 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight mb-4">Comunidad Espacio Epilepsia</h1>
          <p className="text-lg text-gray-600 max-w-2xl leading-relaxed">Un espacio para compartir, aprender y acompañarse. Porque la epilepsia se lleva mejor en comunidad.</p>
        </div>
      </section>
