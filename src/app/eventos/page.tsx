...
<Navbar />
      ...
      <section className="pt-[70px]" style={{ background: "#5c29c2" }}>
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">Eventos</h1>
          <p className="text-lg text-white/70 max-w-xl leading-relaxed">Charlas, congresos, capacitaciones y encuentros de la comunidad de Espacio Epilepsia.</p>
        </div>
      </section>
